...
/// <summary>
/// Use [MinMaxSlider] as an attribute on class fields to show a min-max range picker
/// </summary>
/// <see cref="https://www.youtube.com/watch?v=H9s4d7OLcBw"/>
public class SimpleMinMaxSliderAttribute : PropertyAttribute
{
    public float min;
    public float max;

    public SimpleMinMaxSliderAttribute(float min, float max)
    {
        this.min = min;
        this.max = max;
    }
...
[CustomPropertyDrawer(typeof(SimpleMinMaxSliderAttribute))]
public class SimpleMinMaxSliderDrawer : PropertyDrawer
{
    public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
    {
        var minMaxAttribute = (SimpleMinMaxSliderAttribute)attribute;
