...
namespace Sirenix.OdinInspector.Modules.UnityMathematics.Editor
{
    ...
    public class Float2Drawer : OdinValueDrawer<float2>, IDefinesGenericMenuItems
    {
        ...
        {
            var value = (float2)property.ValueEntry.WeakSmartValue;
            ...
            genericMenu.AddItem(new GUIContent("Normalize"), Mathf.Approximately(vec.magnitude, 1f), () => this.NormalizeEntries(property));
            genericMenu.AddItem(new GUIContent("Zero", "Set the vector to (0, 0)"), vec == Vector2.zero, () => this.SetVector(property, Vector2.zero));
            genericMenu.AddItem(new GUIContent("One", "Set the vector to (1, 1)"), vec == Vector2.one, () => this.SetVector(property, Vector2.one));
            genericMenu.AddSeparator("");
            genericMenu.AddItem(new GUIContent("Right", "Set the vector to (1, 0)"), vec == Vector2.right, () => this.SetVector(property, Vector2.right));
            genericMenu.AddItem(new GUIContent("Left", "Set the vector to (-1, 0)"), vec == Vector2.left, () => this.SetVector(property, Vector2.left));
            genericMenu.AddItem(new GUIContent("Up", "Set the vector to (0, 1)"), vec == Vector2.up, () => this.SetVector(property, Vector2.up));
            genericMenu.AddItem(new GUIContent("Down", "Set the vector to (0, -1)"), vec == Vector2.down, () => this.SetVector(property, Vector2.down));
        }
    ...
    public class Float3Drawer : OdinValueDrawer<float3>, IDefinesGenericMenuItems
    {
        ...
        public void PopulateGenericMenu(InspectorProperty property, GenericMenu genericMenu)
        {
            var value = (float3)property.ValueEntry.WeakSmartValue;
            ...
            genericMenu.AddItem(new GUIContent("Normalize"), Mathf.Approximately(vec.magnitude, 1f), () => this.NormalizeEntries(property));
            genericMenu.AddItem(new GUIContent("Zero", "Set the vector to (0, 0, 0)"), vec == Vector3.zero, () => this.SetVector(property, Vector3.zero));
            genericMenu.AddItem(new GUIContent("One", "Set the vector to (1, 1, 1)"), vec == Vector3.one, () => this.SetVector(property, Vector3.one));
            genericMenu.AddSeparator("");
            genericMenu.AddItem(new GUIContent("Right", "Set the vector to (1, 0, 0)"), vec == Vector3.right, () => this.SetVector(property, Vector3.right));
            genericMenu.AddItem(new GUIContent("Left", "Set the vector to (-1, 0, 0)"), vec == Vector3.left, () => this.SetVector(property, Vector3.left));
            genericMenu.AddItem(new GUIContent("Up", "Set the vector to (0, 1, 0)"), vec == Vector3.up, () => this.SetVector(property, Vector3.up));
            genericMenu.AddItem(new GUIContent("Down", "Set the vector to (0, -1, 0)"), vec == Vector3.down, () => this.SetVector(property, Vector3.down));
            genericMenu.AddItem(new GUIContent("Forward", "Set the vector property to (0, 0, 1)"), vec == Vector3.forward, () => this.SetVector(property, Vector3.forward));
            genericMenu.AddItem(new GUIContent("Back", "Set the vector property to (0, 0, -1)"), vec == Vector3.back, () => this.SetVector(property, Vector3.back));
        }
    ...
    public class Float4Drawer : OdinValueDrawer<float4>, IDefinesGenericMenuItems
    {
        ...
        public void PopulateGenericMenu(InspectorProperty property, GenericMenu genericMenu)
        {
            var value = (float4)property.ValueEntry.WeakSmartValue;
            ...
            genericMenu.AddItem(new GUIContent("Normalize"), Mathf.Approximately(vec.magnitude, 1f), () => this.NormalizeEntries(property));
            genericMenu.AddItem(new GUIContent("Zero", "Set the vector to (0, 0, 0, 0)"), vec == Vector4.zero, () => this.SetVector(property, Vector3.zero));
            genericMenu.AddItem(new GUIContent("One", "Set the vector to (1, 1, 1, 1)"), vec == Vector4.one, () => this.SetVector(property, Vector4.one));
            genericMenu.AddSeparator("");
            genericMenu.AddItem(new GUIContent("Right", "Set the vector to (1, 0, 0, 0)"), (Vector3)vec == Vector3.right, () => this.SetVector(property, Vector3.right));
            genericMenu.AddItem(new GUIContent("Left", "Set the vector to (-1, 0, 0, 0)"), (Vector3)vec == Vector3.left, () => this.SetVector(property, Vector3.left));
            genericMenu.AddItem(new GUIContent("Up", "Set the vector to (0, 1, 0, 0)"), (Vector3)vec == Vector3.up, () => this.SetVector(property, Vector3.up));
            genericMenu.AddItem(new GUIContent("Down", "Set the vector to (0, -1, 0, 0)"), (Vector3)vec == Vector3.down, () => this.SetVector(property, Vector3.down));
            genericMenu.AddItem(new GUIContent("Forward", "Set the vector property to (0, 0, 1, 0)"), (Vector3)vec == Vector3.forward, () => this.SetVector(property, Vector3.forward));
            genericMenu.AddItem(new GUIContent("Back", "Set the vector property to (0, 0, -1, 0)"), (Vector3)vec == Vector3.back, () => this.SetVector(property, Vector3.back));
        }
    ...
    public class Double2Drawer : OdinValueDrawer<double2>, IDefinesGenericMenuItems
    {
        ...
        public void PopulateGenericMenu(InspectorProperty property, GenericMenu genericMenu)
        {
            var value = (double2)property.ValueEntry.WeakSmartValue;
    ...
    public class Double3Drawer : OdinValueDrawer<double3>, IDefinesGenericMenuItems
    {
        ...
        public void PopulateGenericMenu(InspectorProperty property, GenericMenu genericMenu)
        {
            var value = (double3)property.ValueEntry.WeakSmartValue;
    ...
    public class Double4Drawer : OdinValueDrawer<double4>, IDefinesGenericMenuItems
    {
        ...
        public void PopulateGenericMenu(InspectorProperty property, GenericMenu genericMenu)
        {
            var value = (double4)property.ValueEntry.WeakSmartValue;
